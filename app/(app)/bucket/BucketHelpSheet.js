  ...
  return (
    <div className="fixed inset-0 z-20 flex flex-col justify-end">
      ...
      <div className={`relative bg-white dark:bg-[#2E201C] rounded-t-2xl p-4 max-h-[85vh] overflow-y-auto ${isClosing ? 'animate-slide-down' : 'animate-slide-up'}`}>
        ...
        <button
          onClick={handleClose}
          className="w-full bg-[#C2493A] dark:bg-[#E8675A] text-white text-[13px] font-semibold rounded-[10px] py-[10px] mt-[14px] transition-colors hover:bg-[#A83D30] dark:hover:bg-[#D85A4E]"
        >
          Got it
        </button>
      </div>
