...
export default function MarkDoneSheet({ item, coupleId, onSuccess, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 z-20 flex flex-col justify-end">
      ...
      <div className="relative bg-white dark:bg-[#2E201C] rounded-t-2xl p-5 max-h-[92vh] overflow-y-auto animate-slide-up">
        ...
        <div className="mb-4">
          <p className="text-[13px] font-semibold text-[#1C1210] dark:text-[#FAF3F1]">{item.name}</p>
          <p className="text-[11px] text-[#A07060] dark:text-[#D4A090] mt-0.5 capitalize">{item.category}</p>
        </div>
