    ...
    <div className="animate-pulse">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="h-8 w-28 bg-[#EDE0DC] dark:bg-[#3A2418] rounded-[10px]" />
        </div>
        <div className="grid grid-cols-2 gap-2.5">
          <div className="rounded-[16px] h-[90px] bg-[#FDECEA] dark:bg-[#3D1E18]" />
          <div className="rounded-[16px] h-[90px] bg-[#F5EDE9] dark:bg-[#221714] border border-[#EDE0DC] dark:border-[#3A2418]" />
        </div>
        <div className="h-3 w-28 bg-[#EDE0DC] dark:bg-[#3A2418] rounded" />
      </div>

      {/* Together hero */}
      <div className="mt-6 rounded-[24px] p-5 bg-[#F5EDE9] dark:bg-[#2E201C] border border-[#EDE0DC] dark:border-[#3A2418]">
